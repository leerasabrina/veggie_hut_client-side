...
const ErrorSeller = () => {
    ...
    return (
        <div className='relative'>
          ...
          <button className='lg:ml-[600px] absolute lg:top-[350px] p-2 bg-green-700 rounded-lg text-white' onClick={()=>navigate('/dashboard-seller')} >Back to Dashboard</button>
        </div>
    );
};

export default ErrorSeller;